...
# load model
model = tf.keras.models.load_model("./models/model3-sp")
...
df[["ID", "MOS"]].to_csv("./models/model3-sp/answer.csv", index=False)


# zip upload file
with ZipFile("./models/model3-sp/answer3-sp.csv.zip", 'w') as zipf:
    zipf.write("./models/model3-sp/answer.csv", arcname="answer.csv")
