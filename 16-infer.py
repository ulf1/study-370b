...
df[["ID", "MOS"]].to_csv("./models/model6-rf/answer.csv", index=False)


# zip upload file
with ZipFile("./models/model6-rf/answer6-rf.csv.zip", 'w') as zipf:
    zipf.write("./models/model6-rf/answer.csv", arcname="answer.csv")
