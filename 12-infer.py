...
# load model
model = tf.keras.models.load_model("./models/model2-sp")
...
df[["ID", "MOS"]].to_csv("./models/model2-sp/answer.csv", index=False)


# zip upload file
with ZipFile("./models/model2-sp/answer2-sp.csv.zip", 'w') as zipf:
    zipf.write("./models/model2-sp/answer.csv", arcname="answer.csv")
